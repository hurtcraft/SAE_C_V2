...
Sous windows, le fichier exécutable résultant de la compilation porte le nom du projet suivi de .exe. Sous Visual Studio, il se trouve dans le répertoire Debug de votre projet.
...
La liste des jeux de test actuels est la suivante. Elle a vocation à être compléter.

* in-base.txt : jeu de test du sujet (ne comportant aucune erreur de l'utilisateur)
* ... la suite bientôt ...